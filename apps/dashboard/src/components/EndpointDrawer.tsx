  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden font-sans">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
        <div className="w-screen max-w-xl bg-white dark:bg-[#0d1117] border-l border-zinc-200 dark:border-zinc-800 shadow-2xl flex flex-col">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-2.5">
                ...
                <span className={`px-2.5 py-0.5 rounded-full text-[11px] font-mono font-semibold border ${
                  ...
                  {activeKeyCount > 0 ? `${activeKeyCount} Vaulted Key${activeKeyCount > 1 ? 's' : ''}` : 'Pass-Through Routing'}
                </span>
              </div>
              <p className="text-xs text-zinc-500 dark:text-zinc-400 font-sans">
                {meta.category} · Integrated Providers: <strong className="text-zinc-800 dark:text-zinc-200 font-mono capitalize">{meta.providers.join(', ')}</strong>
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800/80 flex items-center justify-between text-xs font-mono">
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-zinc-700 dark:text-zinc-300">
                  {activeKeyCount > 0 ? 'Routing via personal encrypted BYOK keys' : 'Routing via LiteDaemon Master Gateway Pool'}
                </span>
              </div>
              <button
          ...
          {/* Footer */}
          <div className="p-4 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 flex justify-between items-center text-xs font-mono">
