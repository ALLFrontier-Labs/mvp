    ...
    <header className="space-y-6 font-sans selection:bg-[#ccff00] selection:text-black">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-800/80 pb-6">
        <div className="space-y-1.5">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg bg-lime-500/20 border border-lime-500/30 text-lime-400 flex items-center justify-center font-bold text-sm">
          ...
          <div className="flex items-center gap-2 text-xs text-zinc-400 font-mono">
            ...
            <button
              ...
              className="p-1 hover:text-zinc-200 hover:bg-zinc-800 rounded transition-colors cursor-pointer"
        ...
        <div className="flex items-center gap-2 shrink-0 font-mono">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg bg-lime-400 hover:bg-lime-300 text-zinc-950 font-extrabold text-xs shadow-sm transition-colors cursor-pointer"
          >
      ...
      <div className="space-y-2 max-w-4xl">
        ...
        <button
          ...
          className="inline-flex items-center gap-1 text-xs text-lime-400 hover:text-lime-300 font-medium transition-colors cursor-pointer"
        >
          ...
          <div className="flex items-center gap-1.5 text-xs text-zinc-200">
            <div className="flex items-center gap-1">
              {tool.modalities.inputs.map((inp, idx) => (
                <span key={idx} className="px-1.5 py-0.5 rounded bg-zinc-800 text-zinc-300 text-[10px] font-mono">
                  {inp.charAt(0)}
                </span>
              ))}
            </div>
            ...
            <div className="flex items-center gap-1">
              {tool.modalities.outputs.map((out, idx) => (
                <span key={idx} className="px-1.5 py-0.5 rounded bg-lime-500/10 text-lime-400 border border-lime-500/20 text-[10px] font-mono">
                  {out.charAt(0)}
                </span>
              ))}
            </div>
